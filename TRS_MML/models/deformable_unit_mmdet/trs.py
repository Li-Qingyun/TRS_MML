...
from TRS_MML.models.deformable_unit_mmdet.unit_base_model import (
    MLP,
    build_detection_loss,
)
from mmf.common.registry import registry
from mmf.utils.distributed import byte_tensor_to_object
from TRS_MML.models.deformable_unit_mmdet.unit_base_model import UniTBaseModel
from TRS_MML.models.deformable_unit_mmdet.misc import inverse_sigmoid


logger = logging.getLogger(__name__)


@registry.register_model("deformable_trs_mmdet")
class DTRSmmdet(UniT):
    ...
    @classmethod
    def config_path(cls):
        return "TRS_MML/configs/base/models/trs/develop_mmdet.yaml"
    ...
    def build(self):
        ...
        self.as_two_stage = self.two_stage
    ...
    def forward(self, sample_list):
        ...
        detr_outputs = self.base_model(
            ...
            task_idx=self.get_task_idx(dataset_name),
            reg_branches=self.bbox_embeds[dataset_name] if self.with_box_refine else None,  # noqa:E501
            cls_branches=self.class_embeds[dataset_name] if self.as_two_stage else None  # noqa:E501
        )
