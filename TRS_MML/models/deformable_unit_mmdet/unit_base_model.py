...
from TRS_MML.models.deformable_unit.backbone import build_unit_convnet_backbone
from TRS_MML.models.deformable_unit.matcher import HungarianMatcher
from TRS_MML.models.deformable_unit.misc import NestedTensor, sigmoid_focal_loss, accuracy
from mmf.models.unit.transformer import UniTTransformer
from TRS_MML.models.deformable_unit.transformer import DeformableTransformer
...
class UniTBaseModel(nn.Module):
    def __init__(self, args):
        ...
        self.as_two_stage = args.two_stage  # TODO: ADD API
        ...
        from TRS_MML.models.trs.trs_transformer import TRSDeformableBuilder
        transformer_builder = TRSDeformableBuilder(args)
        self.transformer = transformer_builder.build_transformer()
            ...
            for task_type in self.num_queries:
                ...
                for dataset in self.num_queries[task_type]:
                    task_dict[dataset] = nn.Embedding(
                        self.num_queries[task_type][dataset], decoder_hidden_dim*2
                    )
    ...
    def forward(
        ...
        query_embeds = None
        if not self.two_stage:
            query_embeds = self.query_embeds[task_type][dataset_name].weight
        hs, init_reference, inter_references, enc_outputs_class, enc_outputs_coord_unact = \
            self.transformer(srcs, masks, query_embeds, pos,
                             reg_branches=reg_branches if self.with_box_refine else None,  # noqa:E501
                             cls_branches=cls_branches if self.as_two_stage else None  # noqa:E501
                             )
...
def build_detection_loss(args, num_classes):
