...
class UniT(BaseModel):
    ...
    def build(self):
        ...
        # build the text encoder (BERT)  # TODO: Delete BERT (start)
        ...
        bert_config.hidden_size = detr_hidden_dim  # TODO: Delete BERT (end)
        ...
        self.classifiers["vl"] = vl_classifiers                                 # TODO: Delete VL Head (end)
        self.dropout = nn.Dropout(bert_config.hidden_dropout_prob)              # TODO: Delete BERT

        glue_classifiers = nn.ModuleDict()                                      # TODO: Delete GLUE Head (start)
        ...
        self.classifiers["glue"] = glue_classifiers                             # TODO: Delete GLUE Head (end)
        ...
        self.losses_dict["vl"] = {
            ...
            for name in self.config.heads.get('vl', {})  # self.config.heads["vl"]
        }
    ...
    def get_task_type(self, dataset_name):
        task_type = "detection"
        if dataset_name in self.config.heads.get('vl', {}):  # self.config.heads["vl"]
            task_type = "vl"
